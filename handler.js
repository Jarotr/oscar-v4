...
export async function participantsUpdate({ id, participants, action }) {
    ...
    conn.sendButtonDoc(id, text, wm, action == 'add' ? 'ᴡᴇʟᴄᴏᴍᴇ' : 'sᴀʏᴏɴᴀʀᴀᴀ', action === 'add' ? '.intro' : 'oscar versi jawa', fkontak, { contextInfo: { externalAdReply: { showAdAttribution: true,
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*ᴏɴʟʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ* • command iki di gawe developer bot',
        owner: '*ᴏɴʟʏ ᴏᴡɴᴇʀ* • command iki di gawe owner bot',
        mods: '*ᴏɴʟʏ ᴍᴏᴅᴇʀᴀᴛᴏʀ* • command iki di gawe moderator ',
        premium: '*ᴏɴʟʏ ᴘʀᴇᴍɪᴜᴍ* • command iki di gawe premium user',
        group: '*ɢʀᴏᴜᴘ ᴄʜᴀᴛ* • 𝘤𝘰𝘮𝘮𝘢𝘯d 𝘪𝘬𝘪 𝘮𝘦𝘬 𝘪𝘴𝘰 𝘥𝘪 𝘨𝘢𝘸𝘦 𝘥𝘦𝘬 𝘯𝘫𝘦𝘳𝘰 𝘨𝘳𝘰𝘶𝘱',
        private: '*ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ* • 𝘤𝘰𝘮𝘮𝘢𝘯𝘥 𝘪𝘬𝘪 𝘮𝘦𝘬 𝘪𝘴𝘰 𝘥𝘪 𝘨𝘢𝘸𝘦 𝘥𝘦𝘬 𝘱𝘳𝘪𝘷𝘢𝘵𝘦 𝘤𝘩𝘢𝘵',
        admin: '*ᴏɴʟʏ ᴀᴅᴍɪɴ* • 𝘤𝘰𝘮𝘮𝘢𝘯𝘥 𝘪𝘬𝘪 𝘮𝘦𝘬 iso di 𝘯𝘨𝘨𝘰 𝘢𝘥𝘮𝘪𝘯',
        botAdmin: '*ᴏɴʟʏ ʙᴏᴛ ᴀᴅᴍɪɴ* • 𝘤𝘰𝘮𝘮𝘢𝘯𝘥 𝘪𝘬𝘪 𝘥𝘪 𝘨𝘢𝘸𝘦 𝘬𝘦𝘵𝘪𝘬𝘢 𝘣𝘰𝘵 𝘥𝘢𝘥𝘪 𝘢𝘥𝘮𝘪𝘯',
...
if (msgg) return conn.sendButton(m.chat, `${global.htki} VERIFY ${global.htka}`, msgg, null, ['- 𝕃𝕆𝔾𝕀ℕ -', '/verify'],m)
}
