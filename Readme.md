...
| **Quotes** |[](https://github.com/Alpiii22) |
...
$ git clone https://github.com/Alpiii22/oscar-md-versi jawa
$ cd oscar-md-versi jawa
$ npm i 
```
...
## Tempat session 
* session name [Here](https://github.com/Alpiii22/oscar-md-v4/tree/master/auth_info_baileys)
